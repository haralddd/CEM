"""
    SimulationPreAlloc{N<:Integer}(Mpq::Matrix{ComplexF64}, Npk::Matrix{ComplexF64}, Fys::Vector{ComplexF64}, sFys::Vector{ComplexF64}, ys::Vector{Float64})

SimulationPreAlloc{N<:Integer} is a struct which contains all
...
struct SimulationPreAlloc
    ...
    function SimulationPreAlloc(Nq::Integer, Nk::Integer)
